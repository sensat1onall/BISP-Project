...
import { User, Mail, Lock, Eye, EyeOff, MapPin, Loader2, ArrowRight, Mountain } from 'lucide-react';
...
export const Register = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex flex-col">
            {/* Hero Section */}
            <div className="relative h-52 bg-gradient-to-br from-emerald-600 via-teal-500 to-cyan-500 overflow-hidden">
                {/* Decorative elements */}
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-6">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight">{t.joinUs}</h1>
                    <p className="text-white/80 text-sm mt-1">{t.joinUsSub}</p>
                </div>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="pt-2">
                            ...
                            >
                                ...
                                {isLoading ? translations[language].common.loading : t.register}
                            </MetalButton>
                        </div>
                    </form>
